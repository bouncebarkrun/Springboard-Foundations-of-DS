...
##The inflection point at 3 suggests 3 clusters is best. This is the point at which
##the within groups sum of squares drops off.
...
#This does appear to be a good clustering into 3 fairly clear groups!